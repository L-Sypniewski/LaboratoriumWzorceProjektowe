...
class Klawisz
{
  ...
  public:
    ...
    void update();
    void zarejestrujDoSubjecta(Klawiatura *keyboard);
};
...
void Klawisz::zarejestrujDoSubjecta(Klawiatura *keyboard)
{
...
int main()
{
    ...
    k1.zarejestrujDoSubjecta(&keyboard);
    k2.zarejestrujDoSubjecta(&keyboard);
    k3.zarejestrujDoSubjecta(&keyboard);
    k4.zarejestrujDoSubjecta(&keyboard);
